...
import { ArrowLeft, ExternalLink, MoreVertical, Edit, Mail, Check, X } from "lucide-react";
...
const MerchantDetail = () => {
  ...
  const [vendor, setVendor] = useState({
    ...
    referralLink: "https://checkout.sharpei.com/ref/techmart",
    integrationMethod: "Website embed",
    applications: [
      { id: "APP-2024-001", customer: "Acme Corp", amount: "$15,000", status: "completed", date: "Jan 20, 2024" },
      { id: "APP-2024-015", customer: "BuildRight LLC", amount: "$32,500", status: "funded", date: "Feb 5, 2024" },
      { id: "APP-2024-028", customer: "Metro Services", amount: "$8,200", status: "incomplete", date: "Feb 18, 2024" },
      { id: "APP-2024-041", customer: "Peak Industries", amount: "$22,000", status: "completed", date: "Mar 2, 2024" },
      { id: "APP-2024-055", customer: "Sunrise Co", amount: "$11,750", status: "funded", date: "Mar 15, 2024" },
    ],
  });
